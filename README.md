...
- **Gemini AI (banana nano)**: Sends the image to Gemini 1.5 Flash (latest) and requests a larger canvas with generated bleed.
...
- Gemini AI uses the `gemini-1.5-flash-latest` model for low-cost, free-tier-friendly generations.
